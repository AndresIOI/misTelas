...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <select name="tipo">
                ...
                <option value=3>Usuario Telas</option>
                <option value=4>Usuario Habilitación</option>
                <option value=5>Usuario Productos Terminados</option>
                <option value=6>Usuario Observador</option>
        </select>
    </div>
</div>
